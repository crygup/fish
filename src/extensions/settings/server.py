...
class Server(Cog):
    ...
    @commands.hybrid_group(
        name="youtube-notifications", aliases=("ytnotify",), fallback="list"
    )
    @commands.has_guild_permissions(manage_guild=True)
    @commands.guild_only()
    async def youtube_notifications(self, ctx: GuildContext):
        """Manage YouTube channel notifications for this server."""
        rows = await self.bot.pool.fetch(
    ...
    @youtube_notifications.command(name="follow")
    @commands.has_guild_permissions(manage_guild=True)
    @commands.guild_only()
    async def youtube_notifications_follow(
        self,
        ctx: GuildContext,
        channel: str,
        announcement_channel: Optional[discord.TextChannel] = None,
    ...
    @youtube_notifications.command(name="events")
    @commands.has_guild_permissions(manage_guild=True)
    @commands.guild_only()
    async def youtube_notifications_events(
        self, ctx: GuildContext, channel: str, *, events: str
    ):
    ...
    @youtube_notifications.command(name="message", aliases=("customize", "text"))
    @commands.has_guild_permissions(manage_guild=True)
    @commands.guild_only()
    async def youtube_notifications_message(
    ...
    @youtube_notifications.command(name="unfollow", aliases=("remove", "delete"))
    @commands.has_guild_permissions(manage_guild=True)
    @commands.guild_only()
    async def youtube_notifications_unfollow(self, ctx: GuildContext, *, channel: str):
