...
- username, display-name, discriminator, nickname, avatar, guild-name, guild-icon, membership, status, command-use, XP, reaction, pinboard, and Pokémon-solve history;
